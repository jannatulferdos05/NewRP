...
<div class="hero_area">
    ...
    <div class="main-panel">
        ...
        <div class="content-wrapper" style="margin-left: 300px; margin-right: 50;">
            ...
            <div class="div_center" style="margin-left: 80px;margin-top: 40px;">
                <h1 style="font-size: 40px; padding-bottom: 40px; color: teal; font-weight: bold;">Add Project</h1>

                <form style="width: 500px;" action="{{url('/new_robotics')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="div_design">
                        ...
                        <textarea class="text_color" type="text" name="description"  placeholder="Write a description" required=""></textarea>
                    </div>
